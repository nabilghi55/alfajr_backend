...
@section('content')
    <div class="max-w-7xl mx-auto pb-20">
        ...
        <form action="{{ route('paket.update', $paket->id) }}" method="POST" enctype="multipart/form-data" id="formPaket">
            @csrf
            @method('PUT')
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="judul" class="w-full rounded-lg border-gray-300 focus:border-blue-500"
                                    placeholder="Contoh: Paket Umroh Awal Tahun" value="{{ old('judul', $paket->judul) }}" required>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="deskripsi" rows="3" class="w-full rounded-lg border-gray-300 focus:border-blue-500">{{ old('deskripsi', $paket->deskripsi) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="maskapai" class="w-full rounded-lg border-gray-300 focus:border-blue-500" value="{{ old('maskapai', $paket->maskapai) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="rute_penerbangan" class="w-full rounded-lg border-gray-300 focus:border-blue-500" 
                                    value="{{ old('rute_penerbangan', $paket->rute_penerbangan) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="bandara_keberangkatan" class="w-full rounded-lg border-gray-300 focus:border-blue-500" 
                                    value="{{ old('bandara_keberangkatan', $paket->bandara_keberangkatan) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="kota_keberangkatan" class="w-full rounded-lg border-gray-300 focus:border-blue-500" 
                                    value="{{ old('kota_keberangkatan', $paket->kota_keberangkatan) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="jadwal_keberangkatan" class="w-full rounded-lg border-gray-300 focus:border-blue-500" 
                                    value="{{ old('jadwal_keberangkatan', $paket->jadwal_keberangkatan) }}">
                            </div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <select name="status_paket" class="w-full rounded-lg border-gray-300 focus:border-blue-500">
                                    <option value="Tersedia" {{ old('status_paket', $paket->status_paket) == 'Tersedia' ? 'selected' : '' }}>🟢 Tersedia</option>
                                    <option value="Sisa" {{ old('status_paket', $paket->status_paket) == 'Sisa' ? 'selected' : '' }}>🟠 Sisa Sedikit</option>
                                    <option value="Penuh" {{ old('status_paket', $paket->status_paket) == 'Penuh' ? 'selected' : '' }}>🔴 Penuh</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="tipe_paket" value="{{ old('tipe_paket', $paket->tipe_paket) }}" class="w-full rounded-lg border-gray-300 focus:border-blue-500" placeholder="VIP">
                            </div>
                            ...
                            <div>
                                ...
                                @if($paket->itinerary)
                                    <div class="mb-2 flex items-center text-sm text-blue-600 bg-blue-50 p-2 rounded">
                                        ...
                                        <a href="{{ asset('storage/'.$paket->itinerary) }}" target="_blank" class="hover:underline">Lihat PDF Saat Ini</a>
                                    </div>
                                @endif
                        ...
                        <div class="p-6 space-y-5">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="harga_tampil" value="{{ old('harga_tampil', number_format($paket->harga_tampil, 0, ',', '.')) }}" 
    ...
    {{-- HIDDEN DATA UNTUK JS (Menghindari Error Syntax Blade di VS Code) --}}
    <div id="initial-data" 
         data-harga="{{ json_encode($paket->daftar_harga ?? []) }}" 
         data-akomodasi="{{ json_encode($paket->akomodasi ?? []) }}"
         data-termasuk="{{ is_array($paket->harga_termasuk) ? json_encode($paket->harga_termasuk) : '[]' }}"
         data-tidak-termasuk="{{ is_array($paket->harga_tidak_termasuk) ? json_encode($paket->harga_tidak_termasuk) : '[]' }}"
         data-bonus="{{ is_array($paket->bonus_paket) ? json_encode($paket->bonus_paket) : '[]' }}"
         class="hidden">
    </div>

    {{-- =======================================================
    JAVASCRIPT (Auto Populate & Logic)
    ======================================================= --}}
    <script>
